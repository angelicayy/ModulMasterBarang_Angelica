                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3 mb-md-0">
                            <div class="text-center">
                                <img src="{{ Vite::asset('resources/images/angel.jpg') }}" class="rounded img-fluid" alt="Profile Picture"  style="width: 200px; height: 250px; object-fit: cover; border: 5px solid #FFF; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);">
